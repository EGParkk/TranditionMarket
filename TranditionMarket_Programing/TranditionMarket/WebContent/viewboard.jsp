      ...
      <br>
        ...
        <%
            ...
            try{
                ...
                PreparedStatement pstmt = conn.prepareStatement("SELECT * from comment join user on comment.uno = user.uno join board on board.bno = comment.bno where comment.bno = ? order by cno desc");			
                pstmt.setInt(1, bno);
